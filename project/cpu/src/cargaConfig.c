...
int cargarConfiguracion() {
  ...
  fd_configuracion = config_create(
    "/home/utnso/tp-2022-1c-Sisop-Oh-Yeah/project/cpu/src/config.cfg");
  ...
  configuracion->entradas_tlb =
    config_get_int_value(fd_configuracion, "ENTRADAS_TLB");
  configuracion->reemplazo_tlb =
    config_get_string_value(fd_configuracion, "REEMPLAZO_TLB");
  configuracion->reetardo_noop =
    config_get_int_value(fd_configuracion, "RETARDO_NOOP");
  configuracion->ip_memoria =
    config_get_string_value(fd_configuracion, "IP_MEMORIA");
  configuracion->puerto_memoria =
    config_get_int_value(fd_configuracion, "PUERTO_MEMORIA");
  configuracion->puerto_escucha_dispatch =
    config_get_int_value(fd_configuracion, "PUERTO_ESCUCHA_DISPATCH");
  configuracion->puerto_escucha_interrupt =
    config_get_int_value(fd_configuracion, "PUERTO_ESCUCHA_INTERRUPT");
