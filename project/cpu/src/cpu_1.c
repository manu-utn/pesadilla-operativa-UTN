...
//            0) { /// DE MEMORIA ANTICIPADAMENTE SE TIENE QUE TRAER EL TAM DE PAGINA PARA HACER LA TRADUCCION DESDE LA
//            TLB
...
//   xlog(COLOR_INFO, "Se actualizó el tiempo de bloqueo de un proceso (pid=%d, tiempo=%d)", pcb->pid,
//   tiempo_bloqueado);
